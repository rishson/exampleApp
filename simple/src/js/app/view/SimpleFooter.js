define([
...
], function (_Widget, Base, ObjectValidator, _TemplatedMixin, _WidgetsInTemplateMixin, template, declare) {
	 ...
	 */
	return declare('app.view.SimpleFooter', [_Widget, Base, _TemplatedMixin, _WidgetsInTemplateMixin], {
